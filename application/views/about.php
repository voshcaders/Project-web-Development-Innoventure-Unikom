            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>Tentang Kami</h3>
                        <p>Program SMK Membangun Desa</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-11 offset-lg-1">
                            <div class="story_info">
                                <div class="row">
                                    <div class="col-lg-9">
                                        <p>Memberikan acuan kepada SMK dan pihak terkait lainnya dalam
											...
											pelaksanaan kegiatan yang dikolaborasikan.</p>
										<p>SMK membangun desa adalah penguatan peran SMK dalam
											pembangunan sumber daya manusia dan ekonomi pedesaan
											dengan berkolaborasi antara Pemerintah Desa dengan pihak terkait lainnya.</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4">
                                        <div class="single_counter text-center">
                                            ...
                                            <p>Tur Telah Berhasil Dilaksanakan</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4">
                                        <div class="single_counter text-center">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <h3>Pembelajaran</h3>
                        <p>Kolaborasi program antara SMK dengan Pemerintah Desa melalui pembelajaran.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <h3>Kewirausahaan</h3>
                        <p>Pengembangan kewirausahaan dalam penguatan peran SMK dalam pembangunan perdesaan diperuntukan bagi peserta didik, lulusan SMK, dan warga masyarakat..</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single_travel text-center">
                        ...
                        <h3>Inovasi Teknologi Tepat Guna</h3>
                        <p>inovasi teknologi tepat guna berdasarkan kepada permasalahan nyata yang dihadapai masyarakat pedesaan, tujuannya adalah untuk mempercepat pengembangan kegiatan usaha ekonomi produktif masyarakat, memperluas lapangan kerja, lapangan usaha, peningkatan produktivitas, dan mutu produksi..</p>
                    </div>
                </div>
