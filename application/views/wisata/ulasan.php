              ...
              <div class="card">
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-hover table-head-bg-primary table-bordered table-striped" id="table1">
                      <thead>
                        <tr>
                          <th>No</th>
                          <th>Nama Member</th>
                      ...
                      <tbody>
                        <?php foreach ($komplain as $key =>  $komp) : ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?= site_url('pihakwisata/ulasan_hapus/' . $komp['id_keluhan']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin Menghapus data');"><i class="fas fa-trash-alt"></i></a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
