          ...
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-5 offset-xl-1 m-xl-auto">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h4>Login Pihak Wisata</h4>
              </div>
              <div class="card-body">
                <form method="POST" action="<?= site_url('login/wisata') ?>">
                  <div class="form-group">
                    <label for="email">Email</label>
                    <input type="text" class="form-control" id="email" name="email" value="<?= set_value('email') ?>" placeholder="email" autofocus>
